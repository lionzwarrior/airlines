...
from gateway.exceptions import AirlineNotFound  # Import the UserNotFound exception
...
class HttpEntrypoint(HttpRequestHandler):
    ...
    mapped_errors = {
        ...
        AirlineNotFound: (404, 'AIRLINE_NOT_FOUND'),  # Map UserNotFound to a 404 status code
    }
